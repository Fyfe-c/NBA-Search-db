select TeamProperty.team_name as TeamName, Owner.owner_name as Owner, Manager.manager_name as Manager, Coach.coach_name as Coach, TeamProperty.arena_name as Arena, Arena.capacity as ArenaCapacity, City.city_name as City
...
where TeamProperty.team_name like 'celtics';